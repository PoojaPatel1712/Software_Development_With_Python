...
lab_hr_txt = Label(clock,text="Hour",font=('Times New Roman',20,"bold"), bg=#3792cb,fg="white")
lab_hr_txt.place(x=120,y=190,height='40',width='100')

lab_min = Label(clock,text="00",font=('Times New Roman',60,"bold"), bg="red",fg="white")
lab_min.place(x=340,y=50,height='110',width='100')
lab_min_txt = Label(clock,text="Min.",font=('Times New Roman',20,"bold"), bg=#3792cb,fg="white")
lab_min_txt.place(x=340,y=190,height='40',width='100')

lab_sec = Label(clock,text="00",font=('Times New Roman',60,"bold"), bg="red",fg="white")
lab_sec.place(x=560,y=50,height='110',width='100')
lab_sec_txt = Label(clock,text="Sec.",font=('Times New Roman',20,"bold"), bg=#3792cb,fg="white")
lab_sec_txt.place(x=560,y=190,height='40',width='100')

lab_am = Label(clock,text="00",font=('Times New Roman',45,"bold"), bg="red",fg="white")
lab_am.place(x=780,y=50,height='110',width='100')
lab_am_txt = Label(clock,text="AM/PM",font=('Times New Roman',20,"bold"), bg=#3792cb,fg="white")
...
lab_date_txt = Label(clock,text="Date",font=('Times New Roman',20,"bold"), bg=#3792cb,fg="white")
...
lab_mo_txt = Label(clock,text="Month",font=('Times New Roman',20,"bold"), bg=#3792cb,fg="white")
...
lab_year_txt = Label(clock,text="Year",font=('Times New Roman',20,"bold"), bg=#3792cb,fg="white")
...
lab_day_txt = Label(clock,text="Day",font=('Times New Roman',20,"bold"), bg=#3792cb,fg="white")
